#
# Copyright (c) 2026, SquareTalk
#
# SPDX-License-Identifier: BSD 2-Clause License
#
"""Serializer for handling raw audio frames from Squaretalk.
...
class SquaretalkSerializer(FrameSerializer):
    ...
    class InputParams(BaseModel):
        """Configuration parameters for SquaretalkSerializer.
    ...
    def __init__(self, call_uuid: str, stream_id: str, params: Optional[InputParams] = None):
        """Initialize the SquaretalkSerializer.

        Args:
            call_uuid: The associated FreeSWITCH Call UUID.
            stream_id: The associated FreeSWITCH Media Stream ID.
            params: Configuration parameters.
        """
        self.call_uuid = call_uuid
        self.stream_id = stream_id
        self._params = params or SquaretalkSerializer.InputParams()
    ...
    async def serialize(self, frame: Frame) -> Union[str, bytes, None]:
        """Serialize a frame to Squaretalk compatible format.
